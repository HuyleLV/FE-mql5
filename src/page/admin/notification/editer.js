...
export function TextEditor({ setQuery }) {
    return (
        <LexicalComposer initialConfig={editorConfig}>
            <div className="relative mx-auto overflow-hidden my-5 w-full max-w-xl rounded-xl border border-gray-300 bg-white text-left font-normal leading-5 text-gray-900">
                ...
                <div className="relative rounded-b-lg border-opacity-5 bg-white">
                    <RichTextPlugin
                        contentEditable={
                            <ContentEditable onChange={event => console.log(event.target.value)} className="lexical min-h-[280px] resize-none px-2.5 py-4 text-base caret-gray-900 outline-none" />
                        }
