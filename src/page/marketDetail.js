...
export default function MarketDetail() {
    ...
    return (
        <div className='max-w-screen-2xl items-center mx-auto pt-10'>
            <p className='font-semibold p-5 text-xl'><span className='text-[#42639c]'>Market</span> / <span className='text-[#42639c]'>MetaTrader 5</span> / Quantum Emperor MT5</p>
            <div className='grid grid-cols-12'>
                <div className='col-span-2 border'>
                    <div className='p-5'>
                        ...
                        <div className='mt-4 text-sm w-full'>
                            <p>Demo downloaded: <span className='pl-2'>9 427</span></p>
                            <p>Published: <span className='pl-2'>8 August 2023</span></p>
                            <p>Current version: <span className='pl-2'>3.5</span></p>
                        </div>
                        <button className='border border-[#42639c] py-2 w-[210px] mt-4 font-lg text-[#42639c] text-sm'>More from author</button>
                    </div>
                </div>
                <div className='col-span-10 border'>
                    ...
                    <div className='p-5'>
                        <p>
                            Introducing <span className='font-bold'>Quantum Emperor EA</span>, the groundbreaking MQL5 expert advisor that's transforming the way you trade the prestigious GBPUSD pair! Developed by a team of experienced traders with trading experience of over 13 years.
                        </p>
                        <p className='pt-2'>
                            ***Buy <span className='font-bold'>Quantum Emperor EA</span> and you could Quantum Trade EA or Quantum Gold Emperor for free !*** Ask in private for more details
                        </p>
                        <p className='pt-2'>
                            <span className='font-bold'>Quantum Emperor EA</span> utilizes a unique strategy where it continuously splits a single trade into seven smaller trades. This means that each time the EA executes a trade, it automatically divides it into seven smaller positions.
                        </p>
                        <p className='pt-2'>
                            <span className='font-bold'>Quantum Emperor EA</span> stands out from other expert advisors due to its remarkable approach to handling losing trades. Unlike traditional methods that solely rely on Stop Loss orders to limit losses, Quantum Emperor EA employs a sophisticated technique to manage losing positions effectively.When faced with a losing seven trades batch, instead of closing them immediately, Quantum Emperor EA divides the next position into seven smaller ones. It then strategically uses the profits from winning trades to gradually close the losing positions, one by one, until all of them are successfully discarded.
                        </p>
                    </div>
